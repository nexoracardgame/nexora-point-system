    ...
    <div className="space-y-5 text-white">
      ...
      <form method="GET" className="grid gap-3 sm:grid-cols-[1fr_190px_auto]">
        ...
        <select
          ...
          disabled
          className="rounded-2xl border border-white/10 bg-black px-4 py-3 text-white outline-none transition hover:border-violet-300/35 hover:bg-white/[0.06]"
        >
        ...
        <button
          type="submit"
          className="rounded-2xl border border-white/10 bg-black px-5 py-3 text-sm font-black text-white transition hover:border-violet-300/35 hover:bg-white/[0.06]"
        >
          ค้นหา
        </button>
      </form>
