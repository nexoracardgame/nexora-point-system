...
const items = [
  ...
  { href: "/admin/card-set-logs", label: "Card Set Logs", icon: Layers3 },
  { href: "/admin/card-rare-logs", label: "Card Rare Logs", icon: Sparkles },
  ...
  return (
    <>
      <aside className="hidden w-[264px] shrink-0 border-r border-white/8 bg-[#090b11]/96 p-5 xl:block">
        <div className="mb-6">
          <HomeLink compact={false} onPrefetch={prefetchAdminRoute} onClose={() => setOpen(false)} />
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="truncate text-lg font-black text-amber-300">Admin Core</div>
            </div>
          </div>
          <button
            type="button"
      ...
      {open ? (
        <div className="fixed inset-0 z-[1200] xl:hidden">
          ...
          <div className="absolute right-0 top-0 h-full w-[88%] max-w-[360px] overflow-y-auto border-l border-white/10 bg-[#090b11] p-4 shadow-[0_30px_100px_rgba(0,0,0,0.6)]">
            ...
            <AdminNav mobile navItems={navItems} onPrefetch={prefetchAdminRoute} onClose={() => setOpen(false)} />
          </div>
        </div>
      ) : null}
    </>
