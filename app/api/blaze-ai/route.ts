...
const COLLECTION_SETS: CollectionSetRecord[] = [
  {
    ...
    reward: "1,500,000 Nex",
    rewardAliases: createRewardAliases("1,500,000", "หนึ่งล้านห้าแสน"),
  ...
  },
  {
    ...
    reward: "1,000,000 Nex",
    rewardAliases: createRewardAliases("1,000,000", "หนึ่งล้าน"),
    level: "เทพปกรณัม (Mythic)",
    rarity: "5 ดาว",
    cardCount: 5,
  ...
  },
  {
    ...
    reward: "900,000 Nex",
    rewardAliases: createRewardAliases("900,000", "เก้าแสน"),
  ...
  },
  {
    ...
    reward: "400,000 Nex",
    rewardAliases: createRewardAliases("400,000", "สี่แสน"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 9,
  ...
  },
  {
    ...
    reward: "200,000 Nex",
    rewardAliases: createRewardAliases("200,000", "สองแสน"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 15,
    cards: [
  ...
  },
  {
    ...
    reward: "100,000 Nex",
    rewardAliases: createRewardAliases("100,000", "1 แสน", "หนึ่งแสน", "แสน"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 10,
  ...
  },
  {
    ...
    reward: "50,000 Nex",
    rewardAliases: createRewardAliases("50,000", "ห้าหมื่น"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 5,
  ...
  },
  {
    ...
    reward: "70,000 Nex",
    rewardAliases: createRewardAliases("70,000", "เจ็ดหมื่น"),
    level: "ตำนาน (Legendary)",
    rarity: "2 ดาว",
    cardCount: 40,
    cards: [
  ...
  },
  {
    ...
    reward: "ทองคำแท่ง 1 บาท",
    rewardAliases: ["ทองคำแท่ง 1 บาท", "ทองคำ", "ทองแท่ง", "gold one", "โกลด์วัน", "nexora gold one"],
    level: "ตำนาน (Legendary)",
    rarity: "2 ดาว",
    cardCount: 40,
    cards: [
  ...
  },
  {
    ...
    reward: "PlayStation 5",
    rewardAliases: ["playstation", "playstation 5", "ps5", "เพลย์", "เครื่องเกม"],
    level: "ตำนาน (Legendary)",
    rarity: "2 ดาว",
    cardCount: 20,
    cards: [
  ...
  },
  {
    ...
    reward: "15,000 Nex",
    rewardAliases: createRewardAliases("15,000", "หนึ่งหมื่นห้าพัน"),
    level: "ตำนาน (Legendary)",
    rarity: "2 ดาว",
    cardCount: 20,
    cards: [
  ...
  },
  {
    ...
    reward: "5,000 Nex",
    rewardAliases: createRewardAliases("5,000", "ห้าพัน"),
    level: "ตำนาน (Legendary)",
    rarity: "2 ดาว",
    cardCount: 10,
    cards: [
  ...
  {
    id: 20,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 20",
    aliases: ["set 20", "เซ็ต 20", "ชุด 20", "ชุดฟอยล์ 20", "foil set 20"],
    reward: "2,500 Nex; ใช้การ์ดฟอยล์ไม่ซ้ำเพิ่ม 20 แบบ รับเพิ่มทั้งหมดเป็น 5,000 Nex",
    rewardAliases: createRewardAliases("2,500", "5000", "5,000", "ห้าพัน"),
    level: "ตำนาน (Legendary)",
    rarity: "3 ดาว",
    cardCount: 5,
    cards: [
      "การ์ดทอง: 002, 094",
      "การ์ดธรรมดา: 105, 179, 285",
    ],
    rule: "เป็นชุดการ์ดฟอยล์พิเศษ; มีเงื่อนไขรางวัลเพิ่มเมื่อใช้การ์ดฟอยล์ไม่ซ้ำเพิ่ม 20 แบบ",
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 21,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 21",
    aliases: ["set 21", "เซ็ต 21", "ชุด 21", "ชุดฟอยล์ 21", "foil set 21"],
    reward: "10,000 Nex; ใช้การ์ดฟอยล์ไม่ซ้ำเพิ่ม 20 แบบ รับเพิ่มทั้งหมดเป็น 14,000 Nex",
    rewardAliases: createRewardAliases("10,000", "14000", "14,000", "หนึ่งหมื่น", "หนึ่งหมื่นสี่พัน"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 12,
    cards: [
      "การ์ดทอง: 005, 084, 094, 131, 214",
      "การ์ดเงิน: 193, 200",
      "การ์ดธรรมดา: 068, 178, 260, 262, 292",
    ],
    rule: "เป็นชุดการ์ดฟอยล์พิเศษ; มีเงื่อนไขรางวัลเพิ่มเมื่อใช้การ์ดฟอยล์ไม่ซ้ำเพิ่ม 20 แบบ",
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 22,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 22",
    aliases: ["set 22", "เซ็ต 22", "ชุด 22", "ชุดฟอยล์ 22", "foil set 22"],
    reward: "2,500 Nex; ใช้การ์ดฟอยล์ไม่ซ้ำเพิ่ม 20 แบบ รับเพิ่มทั้งหมดเป็น 3,500 Nex",
    rewardAliases: createRewardAliases("2,500", "3500", "3,500", "สามพันห้าร้อย"),
    level: "ตำนาน (Legendary)",
    rarity: "3 ดาว",
    cardCount: 3,
    cards: ["การ์ดทอง: 205", "การ์ดธรรมดา: 065, 236"],
    rule: "เป็นชุดการ์ดฟอยล์พิเศษ; มีเงื่อนไขรางวัลเพิ่มเมื่อใช้การ์ดฟอยล์ไม่ซ้ำเพิ่ม 20 แบบ",
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 23,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 23",
    aliases: ["set 23", "เซ็ต 23", "ชุด 23", "ชุดฟอยล์ 23", "foil set 23"],
    reward: "2,500 Nex; ใช้การ์ดฟอยล์ไม่ซ้ำเพิ่ม 60 แบบ รับเพิ่มทั้งหมดเป็น 20,000 Nex",
    rewardAliases: createRewardAliases("2,500", "20000", "20,000", "สองหมื่น"),
    level: "ตำนาน (Legendary)",
    rarity: "2 ดาว",
    cardCount: 2,
    cards: ["การ์ดเงิน: 200, 202"],
    rule: "เป็นชุดการ์ดฟอยล์พิเศษ; มีเงื่อนไขรางวัลเพิ่มเมื่อใช้การ์ดฟอยล์ไม่ซ้ำเพิ่ม 60 แบบ",
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 24,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 24",
    aliases: ["set 24", "เซ็ต 24", "ชุด 24", "ชุดฟอยล์ 24", "foil set 24"],
    reward: "2,500 Nex; ใช้การ์ดฟอยล์ไม่ซ้ำเพิ่ม 20 แบบ รับเพิ่มทั้งหมดเป็น 7,000 Nex",
    rewardAliases: createRewardAliases("2,500", "7000", "7,000", "เจ็ดพัน"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 5,
    cards: ["การ์ดทอง: 214", "การ์ดเงิน: 200", "การ์ดธรรมดา: 068, 069, 293"],
    rule: "เป็นชุดการ์ดฟอยล์พิเศษ; มีเงื่อนไขรางวัลเพิ่มเมื่อใช้การ์ดฟอยล์ไม่ซ้ำเพิ่ม 20 แบบ",
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 25,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 25",
    aliases: ["set 25", "เซ็ต 25", "ชุด 25", "ชุดฟอยล์ 25", "foil set 25"],
    reward: "80,000 Nex",
    rewardAliases: createRewardAliases("80,000", "แปดหมื่น"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 5,
    cards: ["การ์ดทอง: 214", "การ์ดเงิน: 200", "การ์ดธรรมดา: 068, 069, 293"],
    rule: "ใช้การ์ดหลัก 5 ใบ + ใช้การ์ดฟอยล์ไม่ซ้ำกันเพิ่ม 80 แบบ",
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 26,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 26",
    aliases: ["set 26", "เซ็ต 26", "ชุด 26", "ชุดฟอยล์ 26", "foil set 26"],
    reward: "80,000 Nex",
    rewardAliases: createRewardAliases("80,000", "แปดหมื่น"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 5,
    cards: ["การ์ดเงิน: 193, 202", "การ์ดธรรมดา: 068, 236, 260"],
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 27,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 27",
    aliases: ["set 27", "เซ็ต 27", "ชุด 27", "ชุดฟอยล์ 27", "foil set 27"],
    reward: "19,000 Nex",
    rewardAliases: createRewardAliases("19,000", "หนึ่งหมื่นเก้าพัน"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 8,
    cards: ["การ์ดทอง: 080, 205", "การ์ดเงิน: 077, 078, 081, 202, 203, 204"],
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 28,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 28",
    aliases: ["set 28", "เซ็ต 28", "ชุด 28", "ชุดฟอยล์ 28", "foil set 28"],
    reward: "4,500 Nex",
    rewardAliases: createRewardAliases("4,500", "สี่พันห้าร้อย"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 12,
    cards: ["การ์ดทอง: 020", "การ์ดเงิน: 202", "การ์ดธรรมดา: 021, 022, 023, 024, 025, 026, 027, 028, 029, 030"],
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 29,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 29",
    aliases: ["set 29", "เซ็ต 29", "ชุด 29", "ชุดฟอยล์ 29", "foil set 29"],
    reward: "4,000 Nex",
    rewardAliases: createRewardAliases("4,000", "สี่พัน"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 22,
    cards: [
      "การ์ดทอง: 205, 207, 208, 211, 212, 213, 214",
      "การ์ดเงิน: 215",
      "การ์ดธรรมดา: 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 228, 229",
    ],
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 30,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 30",
    aliases: ["set 30", "เซ็ต 30", "ชุด 30", "ชุดฟอยล์ 30", "foil set 30"],
    reward: "3,200 Nex",
    rewardAliases: createRewardAliases("3,200", "สามพันสองร้อย"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 8,
    cards: ["การ์ดทอง: 176", "การ์ดธรรมดา: 177, 178, 179, 180, 181, 182, 183"],
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 31,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 31",
    aliases: ["set 31", "เซ็ต 31", "ชุด 31", "ชุดฟอยล์ 31", "foil set 31"],
    reward: "65,000 Nex",
    rewardAliases: createRewardAliases("65,000", "หกหมื่นห้าพัน"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 19,
    cards: [
      "การ์ดทอง: 119, 126, 129, 130, 135",
      "การ์ดเงิน: 115, 116, 117, 118, 120, 121, 122, 123, 124, 125, 127, 128, 134",
      "การ์ดธรรมดา: 068",
    ],
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 32,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 32",
    aliases: ["set 32", "เซ็ต 32", "ชุด 32", "ชุดฟอยล์ 32", "foil set 32"],
    reward: "3,000 Nex; ใช้การ์ดฟอยล์ไม่ซ้ำเพิ่ม 30 แบบ รับเพิ่มทั้งหมดเป็น 6,000 Nex",
    rewardAliases: createRewardAliases("3,000", "6000", "6,000", "สามพัน", "หกพัน"),
    level: "ตำนาน (Legendary)",
    rarity: "5 ดาว",
    cardCount: 21,
    cards: [
      "การ์ดทอง: 168, 171, 172, 173, 174, 176",
      "การ์ดเงิน: 167, 175, 195, 201",
      "การ์ดธรรมดา: 177, 178, 179, 231, 232, 233, 234, 237, 238, 239, 266",
    ],
    rule: "เป็นชุดการ์ดฟอยล์พิเศษ; มีเงื่อนไขรางวัลเพิ่มเมื่อใช้การ์ดฟอยล์ไม่ซ้ำเพิ่ม 30 แบบ",
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 33,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 33",
    aliases: ["set 33", "เซ็ต 33", "ชุด 33", "ชุดฟอยล์ 33", "foil set 33"],
    reward: "90,000 Nex",
    rewardAliases: createRewardAliases("90,000", "เก้าหมื่น"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 4,
    cards: ["การ์ดทอง: 205", "การ์ดเงิน: 215", "การ์ดธรรมดา: 105, 284"],
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 34,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 34",
    aliases: ["set 34", "เซ็ต 34", "ชุด 34", "ชุดฟอยล์ 34", "foil set 34"],
    reward: "25,000 Nex",
    rewardAliases: createRewardAliases("25,000", "สองหมื่นห้าพัน"),
    level: "ตำนาน (Legendary)",
    rarity: "5 ดาว",
    cardCount: 22,
    cards: ["การ์ดธรรมดา: 241, 242, 243, 244, 245, 246, 247, 248, 249, 250, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 290, 291"],
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 35,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 35",
    aliases: ["set 35", "เซ็ต 35", "ชุด 35", "ชุดฟอยล์ 35", "foil set 35"],
    reward: "12,000 Nex",
    rewardAliases: createRewardAliases("12,000", "หนึ่งหมื่นสองพัน"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 16,
    cards: [
      "การ์ดเงิน: 043, 187, 188, 191, 192, 195, 196, 197, 198, 199, 200, 201, 202",
      "การ์ดธรรมดา: 184, 185, 186",
    ],
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 36,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 36",
    aliases: ["set 36", "เซ็ต 36", "ชุด 36", "ชุดฟอยล์ 36", "foil set 36"],
    reward: "4,000 Nex",
    rewardAliases: createRewardAliases("4,000", "สี่พัน"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 9,
    cards: ["การ์ดเงิน: 098", "การ์ดธรรมดา: 099, 100, 101, 102, 103, 104, 105, 106"],
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 37,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 37",
    aliases: ["set 37", "เซ็ต 37", "ชุด 37", "ชุดฟอยล์ 37", "foil set 37"],
    reward: "3,000 Nex",
    rewardAliases: createRewardAliases("3,000", "สามพัน"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 7,
    cards: ["การ์ดทอง: 054, 055, 056, 057, 059", "การ์ดเงิน: 048, 058"],
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 38,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 38",
    aliases: ["set 38", "เซ็ต 38", "ชุด 38", "ชุดฟอยล์ 38", "foil set 38"],
    reward: "79,000 Nex",
    rewardAliases: createRewardAliases("79,000", "เจ็ดหมื่นเก้าพัน"),
    level: "ตำนาน (Legendary)",
    rarity: "4 ดาว",
    cardCount: 15,
    cards: ["การ์ดเงิน: 031, 032, 033, 034, 035, 037, 038, 039, 044, 045, 046, 047, 048, 049, 050"],
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 39,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 39",
    aliases: ["set 39", "เซ็ต 39", "ชุด 39", "ชุดฟอยล์ 39", "foil set 39"],
    reward: "35,000 Nex",
    rewardAliases: createRewardAliases("35,000", "สามหมื่นห้าพัน"),
    level: "ตำนาน (Legendary)",
    rarity: "5 ดาว",
    cardCount: 28,
    cards: [
      "การ์ดทอง: 051, 052, 084, 091, 094, 095, 096, 097, 160",
      "การ์ดเงิน: 082, 083, 092, 093, 098, 161, 162, 163",
      "การ์ดธรรมดา: 060, 062, 099, 107, 110, 112, 113, 114, 115, 158, 159",
    ],
    sourceUrl: COLLECTION_SOURCE_URL,
  },
  {
    id: 40,
    name: "ชุดการ์ดสะสมแบบฟอยล์ที่ 40",
    aliases: ["set 40", "เซ็ต 40", "ชุด 40", "ชุดฟอยล์ 40", "foil set 40", "ฟอยล์ 36 ใบ"],
    reward: "15,000 Nex",
    rewardAliases: createRewardAliases("15,000", "หนึ่งหมื่นห้าพัน"),
    level: "ตำนาน (Legendary)",
    rarity: "5 ดาว",
    cardCount: 1,
    cards: [
      "เลือกใช้การ์ดฟอยล์ 1 แบบ จำนวน 36 ใบ",
      "การ์ดทองที่เลือกได้: 004, 005, 041, 169, 174",
      "การ์ดเงินที่เลือกได้: 036, 040, 042, 050, 089, 156, 159, 163, 193, 200, 206, 215",
      "การ์ดธรรมดาที่เลือกได้: 063, 064, 065, 067, 069, 105, 140, 141, 142, 236, 244, 263, 264, 265, 268, 272, 278, 279, 284, 285, 288, 293",
    ],
    rule:
      "เซ็ต 40 เป็นกติกาพิเศษ: เลือกการ์ดฟอยล์แบบใดก็ได้ 1 แบบจากรายการที่กำหนด แล้วสะสมหมายเลขนั้นซ้ำให้ครบ 36 ใบ จึงแลกได้ 15,000 Nex",
    sourceUrl: COLLECTION_SOURCE_URL,
  },
];
...
const BLAZE_CORE_KNOWLEDGE = [
  ...
  "- คู่มือแอพ NEX POINT: แอพนี้เป็นศูนย์กลางบัญชีผู้เล่น NEXORA ใช้ดูยอด NEX/COIN, สแกนการ์ด, เปิดข้อมูลการ์ด, แลกรางวัล, เก็บคูปอง, ซื้อขายการ์ด, ซื้อขายกล่อง, ตั้งโพสต์รับซื้อ, แชท, คอมมูนิตี้, โปรไฟล์ และระบบพนักงาน/แอดมิน",
  "- การเข้าใช้งาน NEX POINT: ผู้ใช้ล็อกอินด้วย LINE หรือ Google. ถ้าขึ้น OAuthAccountNotLinked แปลว่าบัญชีนี้เคยใช้วิธีล็อกอินอื่นไว้ ให้เข้าด้วยวิธีเดิมก่อน หรือเชื่อมบัญชีจากหน้าตั้งค่าโปรไฟล์. ถ้าล็อกอินค้างให้ปิดหน้าแล้วเข้าใหม่ ห้ามกดซ้ำตอนระบบแสดงกำลังเข้าสู่แอพ",
