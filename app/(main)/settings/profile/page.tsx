      ...
      <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[420px_minmax(0,1fr)]">
        ...
        <section className="rounded-[36px] border border-white/10 bg-white/[0.03] p-6 shadow-2xl">
          ...
          <div className="mt-6">
            ...
            <label className="mt-3 flex cursor-pointer items-center justify-between rounded-3xl border border-violet-400/20 bg-gradient-to-r from-violet-500/10 via-fuchsia-500/10 to-pink-500/10 px-5 py-4 transition hover:border-violet-300/40">
              <div>
                <div className="text-sm font-bold text-white">
                  🖼 Choose Cover Image
                </div>
                <div className="mt-1 text-xs text-zinc-400">
                  รองรับคอม / มือถือ / แกลเลอรี่
                </div>
              </div>
