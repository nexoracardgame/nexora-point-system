  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#111119] p-3 text-white sm:p-6">
      ...
      <div className="relative mx-auto max-w-7xl space-y-4 sm:space-y-5">
        <div className="overflow-hidden rounded-[26px] border border-white/10 bg-white/[0.035] shadow-[0_24px_90px_rgba(0,0,0,0.58)] sm:rounded-[36px]">
        ...
        <div className="h-40 animate-pulse rounded-[24px] border border-white/10 bg-white/[0.035] sm:rounded-[34px]" />
      </div>
    </div>
  );
}
